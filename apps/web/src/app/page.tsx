...
export default function WorkspaceLanding() {
  return <>
    ...
    <section className="workspace-choice">
      ...
      <article className="choice-card desk-choice"><div className="choice-icon"><LockKeyhole/></div><span className="mode-label">CONNECTED PAPER · REAL DATA</span><h2>Connected Paper Workspace</h2><p>An invite-only, tenant-isolated desk using your own encrypted Alpaca paper and AI-provider credentials.</p><ul><li>Real Alpaca paper account projections</li><li>Real-source options discovery</li><li>Explicit confirmation for every paper order</li></ul><Link className="choice-action" href="/login">Sign in with invitation <ArrowRight/></Link></article>
    </section>
